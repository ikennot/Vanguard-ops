export const GAME_CONST = {
  ...
  enemy: {
    ...
    canyonJetpackFuelMax: 52,
    canyonJetpackDrainScale: 1.2,
    canyonJetpackRegenScale: 0.55,
    warzoneMaxConcurrentFlyers: 2,
    warzoneFlightFuelUseThreshold: 35,
    warzoneFlightBurstMin: 0.7,
    warzoneFlightBurstMax: 1.35,
    warzoneFlightCooldownMin: 1.2,
    warzoneFlightCooldownMax: 2.6,
    warzoneFlightHeightOffset: 150,
    warzoneJetpackForce: 2150,
    warzoneJetpackFuelMax: 58,
    warzoneJumpForce: -760,
    warzoneJumpCadenceMin: 0.7,
    warzoneJumpCadenceMax: 1.4,
    warzoneDropCadenceMin: 1.2,
    warzoneDropCadenceMax: 2.4
  },
  level5enemy: {
    maxHealth: 220,
    speed: 130,
